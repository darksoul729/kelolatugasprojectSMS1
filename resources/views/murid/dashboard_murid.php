...
<body class="min-h-screen font-sans bg-white relative">
  ...
  <!-- ✅ Main -->
  <main class="pt-20 pb-24 px-4 sm:px-6 min-h-screen flex flex-col items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white rounded-xl p-6 shadow-sm border border-gray-200 backdrop-blur-sm bg-opacity-90">
      <div class="flex flex-col items-center text-center">
        ...
        <a href="?route=murid/kebiasaan/tambah"
           class="w-full max-w-xs bg-blue-600 text-white py-2.5 rounded-lg font-medium hover:bg-blue-700 transition">
          Tambah Kebiasaan
        </a>
        <a href="?route=murid/rekap" class="mt-4 text-sm text-blue-600 hover:underline font-medium">
          Lihat Rekap Bulanan
        </a>
      </div>
    </div>
